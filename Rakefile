...
task :import_bg_action do
    ...
    sh "ssh bi-02 'mkdir -p /data/tmp/import_bg_action' && scp -r  tests/importdb/target/import-db-1.0-jar-with-dependencies.jar  tests/import.sh bi-02:/data/tmp/import_bg_action"
end